...
package net.gabrieldja.trickupdate.world.inventory;
...
public class ChiseledBookshelfUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ChiseledBookshelfUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TrickUpdate120ModMenus.CHISELED_BOOKSHELF_UI.get(), id);
