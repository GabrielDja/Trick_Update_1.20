...
package net.gabrieldja.trickupdate.world.biome;
...
public class CherryGroveBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(-10635281).waterFogColor(329011).skyColor(7972607).foliageColorOverride(-4793503).grassColorOverride(-4793503).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("trick_update_1_20:grass_cherry_grove", VegetationFeatures.PATCH_GRASS,
