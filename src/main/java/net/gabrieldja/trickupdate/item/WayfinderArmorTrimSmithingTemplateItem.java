...
public class WayfinderArmorTrimSmithingTemplateItem extends Item {
	public WayfinderArmorTrimSmithingTemplateItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Wayfinder Armor Trim"));
