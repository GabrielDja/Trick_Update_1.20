...
public class SuspiciousSandStage3LorsDunClicDroitSurLeBlocProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TrickUpdate120ModItems.BRUSH.get()) {
			...
			world.levelEvent(2001, new BlockPos(x, y, z), Block.getId(TrickUpdate120ModBlocks.SUSPICIOUS_SAND_STAGE_3.get().defaultBlockState()));
