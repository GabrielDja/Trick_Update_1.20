...
public class SuspiciousGravelStage1LorsDunClicDroitSurLeBlocProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TrickUpdate120ModItems.BRUSH.get()) {
			TrickUpdate120Mod.queueServerWork(10, () -> {
				...
				world.setBlock(new BlockPos(x, y, z), TrickUpdate120ModBlocks.SUSPICIOUS_GRAVEL_STAGE_2.get().defaultBlockState(), 3);
			});
		}
	}
}
