package net.gabrieldja.trickupdate.block.entity;
...
public class ChiseledBookshelfBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ChiseledBookshelfBlockEntity(BlockPos position, BlockState state) {
		super(TrickUpdate120ModBlockEntities.CHISELED_BOOKSHELF.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("chiseled_bookshelf");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ChiseledBookshelfUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
